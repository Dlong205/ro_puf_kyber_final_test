...
Trạng thái: **DRAFT**, chưa phải security sign-off.
...
| SEC-02 | High | `m` được trộn từ KDF/cycle/counter, chưa phải entropy source + DRBG đã characterize; cần kiến trúc RBG và xử lý health-test failure. |
...
| SEC-06 | Medium | Zeroize đã có ở seed/status/core path nhưng chưa có chứng minh toàn bộ bản sao trong RAM/register/netlist. |
