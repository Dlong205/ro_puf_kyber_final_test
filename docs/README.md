...
Bằng chứng đến **2026-09-17** cho integration `0.2.0-rc2-dev`. Artifact FPGA được
...
| Bring-up full Edge Zynq-7020 ở 100 MHz | [`ZYNQ_EDGE_100MHZ_BRINGUP_2026-09-17.md`](ZYNQ_EDGE_100MHZ_BRINGUP_2026-09-17.md) |
...
| Candidate pool 496 cặp RO-PUF | [`PUF_ALLPAIRS_CHARACTERIZATION_2026-09-16.md`](PUF_ALLPAIRS_CHARACTERIZATION_2026-09-16.md) |
| Quy trình chọn mapping train/holdout | [`PUF_MAPPING_WORKFLOW.md`](PUF_MAPPING_WORKFLOW.md) |
