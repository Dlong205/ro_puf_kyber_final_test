...
| Same-root binding Phase 1 | **FPGA 100 MHz + BOARD PASS; ASIC top riêng PASS** | Offline regression PASS; Zynq P&R 100 MHz 34.673 LUT, WNS +0,354 ns, WHS +0,034 ns, route sạch; board PASS KCV gate + fail-closed; Edge_Puf_Mlkem_Asic_Top elaborate + e2e sim trên canonical filelist |
