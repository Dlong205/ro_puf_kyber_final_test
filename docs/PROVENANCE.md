...
- Repo Verilog được nhập: `https://github.com/tuandat081125/Kyber.git`
- Commit nguồn cục bộ: `0bb04eee36396c3e9b93cf83c835ac07f1d05338`
...
Chủ repo cho biết Tuấn Đạt là đồng nghiệp đã tạo hoặc thu thập thiết kế Verilog
với sự tham khảo CRYSTALS-Kyber, sau đó dự án này clone và sửa đổi. Cụm từ “dựa
trên thuật toán/reference” chưa đủ để xác định quyền tác giả đối với cách thể hiện
Verilog. Repo clone không chứa commit upstream chính xác hoặc lịch sử chuyển đổi.
...
1. Tuấn Đạt thêm license rõ ràng vào repo nguồn hoặc cung cấp xác nhận có ngày,
   cho phép sửa đổi và phân phối Verilog RTL ở cả dạng source lẫn FPGA bitstream.
2. Ghi chính xác phiên bản/commit CRYSTALS-Kyber được dùng và file Verilog nào là
   bản dịch, bản sửa đổi hoặc chỉ được gợi ý bởi upstream.
...
Cho đến khi hoàn thành các mục này, chỉ chia sẻ RC2 trong repo riêng tư của nhóm.
