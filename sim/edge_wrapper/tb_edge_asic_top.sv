...
module tb_edge_asic_top;
    ...
    Edge_Puf_Mlkem_Asic_Top dut_as (
        ...
        .enroll_allowed_i(1'b1), .trusted_kcv_valid_i(1'b1),
        .trusted_kcv_ref_i(kcv_ref_i), .helper_kcv_ref_i(kcv_ref_i),
        .helper_kcv_valid_i(1'b1), .kcv_ctx_i(56'h01010101_010101),
