# Create the isolated 32-RO/C(32,2) characterization project for Zynq-7020.
set_param general.maxThreads 1
set script_dir [file dirname [file normalize [info script]]]
set root_dir [file normalize [file join $script_dir ..]]
set build_dir [file join $root_dir build puf_allpairs_characterization]
set project_name puf_allpairs_zynq7020
...
set sources [list \
    [file join $root_dir rtl top Puf_AllPairs_Characterization_Top.sv] \
...
if {[llength [get_ips -quiet]] != 0 ||
    ...
    error "Generated Xilinx IP unexpectedly entered the all-pairs project"
}
puts "PUF_ALLPAIRS_PROJECT=[file join $build_dir ${project_name}.xpr]"
