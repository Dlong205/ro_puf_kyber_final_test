# Program exactly one XC7Z020 with the diagnostic all-pairs image.
set script_dir [file dirname [file normalize [info script]]]
set root_dir [file normalize [file join $script_dir ..]]
set bit_file [file join $root_dir build puf_allpairs_characterization \
    puf_allpairs_zynq7020.runs impl_1 Puf_AllPairs_Characterization_Top.bit]
if {![file isfile $bit_file]} { error "All-pairs bitstream not found: $bit_file" }
...
refresh_hw_device $device
puts "PUF_ALLPAIRS_PROGRAM_PASS device=$device bitstream=$bit_file"
close_hw_manager
